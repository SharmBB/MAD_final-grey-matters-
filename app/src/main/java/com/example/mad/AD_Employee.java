...
public class AD_Employee extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.a_d_employee);
        ...
        awesomeValidation.addValidation(this,R.id.emp7, Range.closed(5000,200000),R.string.invalid_salary);
    ...
    public void AddData() {
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent logout = new Intent(AD_Employee.this, AD_Employee.class);
