...
public class booking extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        awesomeValidation.addValidation(this, R.id.personName, NOT_EMPTY, R.string.invalid_name);
        ...
        awesomeValidation.addValidation(this, R.id.cost, NOT_EMPTY, R.string.invalid_cost);
    ...
    public void AddData() {
        ...
        btnlogout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent logout = new Intent(booking.this, booking.class);
